...
<div id="menuContexto">
    ...
    <div id="qm0" class="qmmc">
        ...
        <a class="no_seta" href="<?php echo $this->url(array('module' => 'parecer', 'controller' => 'Analisarprojetoparecer', 'action' => 'fecharparecer', 'idPronac'=> $this->idPronac, 'idD'=> $this->idD, 'idP' => $this->idProduto),'',true); ?>" title="Ir para Consulta">Concluir análise</a>
